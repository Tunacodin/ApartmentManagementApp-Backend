    ...
    public class ContractManager : IContractService
    {
        ...
        public async Task<ApiResponse<ContractDto>> GetByIdAsync(int id)
        {
            ...
            var contractDto = new ContractDto
            {
                ...
                TenantFullName = tenant != null ? $"{tenant.FirstName} {tenant.LastName}" : "",
                OwnerFullName = owner != null ? $"{owner.FirstName} {owner.LastName}" : "",
                ApartmentInfo = apartment != null ? $"No: {apartment.UnitNumber}" : "",
                StartDate = contract.StartDate,
                EndDate = contract.EndDate,
