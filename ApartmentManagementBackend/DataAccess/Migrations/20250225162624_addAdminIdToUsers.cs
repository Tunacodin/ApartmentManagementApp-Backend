...
{
    /// <inheritdoc />
    public partial class addAdminIdToUsers : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrganizedByName = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProfileUpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    AdminId = table.Column<int>(type: "int", nullable: true),
                    IBAN = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    BankName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    BuildingId = table.Column<int>(type: "int", nullable: true),
                    ShiftHours = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    MonthlyDues = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OccupancyRate = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    ...
                    DuesAmount = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    IncludedElectric = table.Column<bool>(type: "bit", nullable: false),
                    IncludedWater = table.Column<bool>(type: "bit", nullable: false),
                    IncludedGas = table.Column<bool>(type: "bit", nullable: false),
                    IncludedInternet = table.Column<bool>(type: "bit", nullable: false),
                    ...
                    HasThermalInsulation = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Buildings_Users_AdminId",
                        column: x => x.AdminId,
